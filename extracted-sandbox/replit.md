...
### UI/UX and Features
- **Dashboard** (`/`): Hero section, stats cards, New Session flow
...
- **Token Usage** (`/usage`): Real-time billing dashboard with cost/provider/model breakdown, 7-day trend chart
...
- **Learned Skills** (`/skills`): Agent skill persistence
...
- `artifacts/agent-sandbox/src/App.tsx` — Frontend routing (11 pages)
