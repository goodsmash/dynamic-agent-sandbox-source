          ...
          {!cf.configured && !qwen.configured && (
            <div className="flex items-start gap-3 p-4 rounded-xl border border-yellow-500/20 bg-yellow-500/5 text-yellow-400">
              ...
              <div className="text-sm">
                <strong>No providers configured yet.</strong> Add Cloudflare (100+ models free) or Alibaba Cloud (90+ models free) above. Set your OPENAI_API_KEY environment variable to enable OpenAI models as a fallback.
              </div>
            </div>
          )}
        </div>
