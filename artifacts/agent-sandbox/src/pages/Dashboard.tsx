...
import { Terminal, Shield, Zap, Server, Network, ShieldCheck, BookOpen, Workflow, ArrowRight, Play } from "lucide-react"
          ...
          <div className="max-w-5xl mx-auto px-8 py-6">
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
              {[
                ...
                { label: "Workflow Templates", value: "12", sub: "ready to import", color: "text-yellow-400" },
