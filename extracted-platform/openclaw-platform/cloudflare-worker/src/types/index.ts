...
export interface Env {
  ...
  // Durable Object namespace — each user/session = one OpenClawAgent instance
  // MUST match class name for routeAgentRequest() to work correctly
  OpenClawAgent: DurableObjectNamespace;
