...
export function Sidebar() {
  ...
  const handleCreate = (e: React.FormEvent) => {
    ...
    createSession(
      { data: { name: newSessionName, model: newSessionModel } },
      {
        onSuccess: () => {
    ...
    <div className="w-72 bg-card border-r border-border h-screen flex flex-col z-10 shadow-2xl shadow-black relative">
      ...
      <Dialog open={isCreateOpen} onOpenChange={setIsCreateOpen}>
        <DialogHeader>
          ...
          <DialogDescription>
            Provision a new sandboxed environment with durable memory.
          </DialogDescription>
        </DialogHeader>
        <form onSubmit={handleCreate} className="space-y-4 py-4">
          ...
          <div className="space-y-2">
            ...
            <p className="text-[10px] text-muted-foreground">
              ...
              <a href="#" onClick={(e) => { e.preventDefault(); window.location.href = "/settings"; }} className="text-primary underline">
                AI Providers
              </a>
            </p>
          </div>
          <DialogFooter>
            ...
            <Button type="submit" disabled={isCreating || !newSessionName}>
